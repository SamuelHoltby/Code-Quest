...
exports.rotate2DMatrixClockwise = exports.rotate3x3_2DMatrixClockwise = void 0;
/**
 ...
 */
const rotate3x3_2DMatrixClockwise = (matrix) => {
...
exports.rotate3x3_2DMatrixClockwise = rotate3x3_2DMatrixClockwise;
const rotate2DMatrixClockwise = (matrix) => {
    const size = matrix.length;
    const newMatrix = Array.from({ length: size }, () => new Array(size).fill(0));
...
exports.rotate2DMatrixClockwise = rotate2DMatrixClockwise;
